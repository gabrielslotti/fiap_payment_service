...
config.set_section_option(section, "DB_PASS", os.environ.get("DB_PASS", "postgres"))  # NOQA
...
config.set_section_option(section, "DB_BASE", os.environ.get("DB_BASE", "food_payment"))  # NOQA
